...
S:Lover_screen.screen_over_screen_load$percent$1$15({4}SF:S),R,0,0,[l,h,e,d]
S:Lover_screen.screen_over_screen_load$sloc0$1$0({4}SF:S),B,1,-4
F:G$screen_over_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lover_screen.screen_over_screen_update$screen_type$1$16({2}DG,SC:U),B,1,4
S:Lover_screen.screen_over_screen_update$input$1$17({1}SC:U),R,0,0,[l]
S:Lover_screen.screen_over_screen_update$level$1$17({1}SC:U),R,0,0,[c]
